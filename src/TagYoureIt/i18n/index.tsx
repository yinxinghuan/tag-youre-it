...
const EN: Dict = {
  ...
  'lobby.no_friends': 'Open in AlterU to load your friends',
  'lobby.no_friends_yet': 'Nobody to tag yet — invite a friend to AlterU',
  ...
  'picker.preview_hint': 'Preview mode — open in AlterU for real friends',
  'picker.loading': 'Loading friends…',
  'picker.empty': 'No friends found on AlterU yet. Invite some first.',
  ...
  'weapon.anvil.desc': 'Acme anvil drop',
  'weapon.glove.desc': 'Spring-loaded boxing glove',
  'weapon.paint.desc': 'Paint can dump',
  'weapon.water.desc': 'Water balloon burst',
  'weapon.horn.desc': 'Giant air horn point-blank',
  'weapon.glitter.desc': 'Glitter bomb explosion',
...
const ZH: Dict = {
  ...
  'lobby.no_friends': '在 AlterU 中打开才能看到好友',
  'lobby.no_friends_yet': '还没有能标记的好友 — 邀请朋友来 AlterU 吧',
  ...
  'picker.preview_hint': '预览模式——在 AlterU 中打开看真实好友',
  'picker.loading': '加载好友中…',
  'picker.empty': 'AlterU 里还没添加好友，先去加几个吧。',
  ...
  'weapon.anvil.desc': '天降铁砧',
  'weapon.glove.desc': '弹簧拳套一击',
  'weapon.paint.desc': '油漆桶倾倒',
  'weapon.water.desc': '水气球爆破',
  'weapon.horn.desc': '巨型气喇叭近距离',
  'weapon.glitter.desc': '亮片炸弹引爆',
...
const JA: Dict = {
  ...
  'lobby.no_friends': 'AlterUで開くと友達が表示されます',
  'lobby.no_friends_yet': 'まだタグ付けできる友達がいません — AlterUに招待しよう',
  ...
  'picker.preview_hint': 'プレビュー · AlterUで開いて本物の友達を読み込む',
  'picker.loading': '友達を読み込み中…',
  'picker.empty': 'AlterUにまだ友達がいません。先に追加してね。',
  ...
  'weapon.anvil.desc': '頭上から鉄床',
  'weapon.glove.desc': 'バネ仕掛けボクシンググローブ',
  'weapon.paint.desc': 'ペンキ缶ぶちまけ',
  'weapon.water.desc': '水風船炸裂',
  'weapon.horn.desc': '至近距離エアホーン',
  'weapon.glitter.desc': 'ラメ爆弾爆発',
...
const KO: Dict = {
  ...
  'lobby.no_friends': 'AlterU에서 열면 친구가 보입니다',
  'lobby.no_friends_yet': '아직 태그할 친구가 없어요 — AlterU에 친구를 초대하세요',
  ...
  'picker.preview_hint': '미리보기 · AlterU에서 열어야 실제 친구가 나옵니다',
  'picker.loading': '친구 불러오는 중…',
  'picker.empty': 'AlterU에 친구가 없습니다. 먼저 친구를 추가하세요.',
  ...
  'weapon.anvil.desc': '머리 위로 떨어지는 모루',
  'weapon.glove.desc': '스프링 권투 글러브',
  'weapon.paint.desc': '페인트 통 쏟아붓기',
  'weapon.water.desc': '물풍선 폭발',
  'weapon.horn.desc': '초근접 거대 에어혼',
  'weapon.glitter.desc': '글리터 폭탄 폭발',
...
const ES: Dict = {
  ...
  'lobby.no_friends': 'Abre en AlterU para ver a tus amigos',
  'lobby.no_friends_yet': 'Aún no hay nadie para tagear — invita a un amigo a AlterU',
  ...
  'picker.preview_hint': 'Previa — abre en AlterU para ver amigos reales',
  'picker.loading': 'Cargando amigos…',
  'picker.empty': 'Aún no hay amigos en AlterU. Añade alguno primero.',
  ...
  'weapon.anvil.desc': 'Yunque Acme desde arriba',
  'weapon.glove.desc': 'Guante de boxeo con resorte',
  'weapon.paint.desc': 'Bote de pintura volcado',
  'weapon.water.desc': 'Globo de agua explotando',
  'weapon.horn.desc': 'Bocina gigante a quemarropa',
  'weapon.glitter.desc': 'Bomba de purpurina',
