...
const EN: Dict = {
  ...
  'lobby.no_friends_yet': 'Nobody to tag yet — invite a friend to Aigram',
...
const ZH: Dict = {
  ...
  'lobby.no_friends_yet': '还没有能标记的好友 — 邀请朋友来 Aigram 吧',
...
const JA: Dict = {
  ...
  'lobby.no_friends_yet': 'まだタグ付けできる友達がいません — Aigram に招待しよう',
...
const KO: Dict = {
  ...
  'lobby.no_friends_yet': '아직 태그할 친구가 없어요 — Aigram에 친구를 초대하세요',
...
const ES: Dict = {
  ...
  'lobby.no_friends_yet': 'Aún no hay nadie para tagear — invita a un amigo a Aigram',
